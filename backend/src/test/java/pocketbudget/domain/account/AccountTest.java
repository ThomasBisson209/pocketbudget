...
class AccountTest {
    ...
    void givenPositiveInitialBalance_whenCreatingAccount_thenAccountIsCreated() {
        Account account = new Account(AccountId.generate(), "Checking", AccountType.CHECKING, 500.0);
    ...
    void givenNegativeInitialBalance_whenCreatingAccount_thenThrowsInvalidBalanceException() {
        assertThrows(InvalidBalanceException.class,
            () -> new Account(AccountId.generate(), "Bad", AccountType.CASH, -100.0));
    }

    @Test
    void givenValidAmount_whenDeposit_thenBalanceIncreases() {
        Account account = new Account(AccountId.generate(), "Savings", AccountType.SAVINGS, 100.0);
    ...
    void givenSufficientFunds_whenWithdraw_thenBalanceDecreases() {
        Account account = new Account(AccountId.generate(), "Checking", AccountType.CHECKING, 200.0);
    ...
    void givenInsufficientFunds_whenWithdraw_thenThrowsInvalidBalanceException() {
        Account account = new Account(AccountId.generate(), "Checking", AccountType.CHECKING, 50.0);
